...
describe("Version File Generator", function () {
  it('should generate a file called "version.json" at the <rootDir> if called without arguments', async function (done: jest.DoneCallback) {
  ...
  it('should write a file in the specified location + filename given by the "outputFile" property', async function (done: jest.DoneCallback) {
  ...
  it('should use an external file as a custom template if specified by "template"', async function (done: jest.DoneCallback) {
    const configObject: Partial<IVersionFileConfigOptions> = {
  ...
  it('should use an inline template specified by "templateString"', async function (done: jest.DoneCallback) {
    const configObject: Partial<IVersionFileConfigOptions> = {
